<template>
  <div class="toast-container fixed top-5 right-5 z-50 flex flex-col space-y-3 max-w-sm w-full pointer-events-none" aria-live="polite" aria-relevant="additions removals">
